  ...
  ({ className, variant, size, asChild = false, children, ...props }, ref) => {
    if (asChild) {
      ...
      if (validChildren.length > 0) {
        ...
        // Filter out non-HTML or unrecognized properties from props when forwarding to child
        // components such as react-router-dom Link to prevent DOM pollution errors.
    ...
    return (
      ...
      >
        ...
        <div className="pointer-events-none z-10 w-full h-full flex items-center justify-center gap-2">
          {children}
        </div>
        <GlassFilter />
      </button>
